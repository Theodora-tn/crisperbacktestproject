...
public class StrongCandleBottomUpStrategy{
    ...
    public Strategy buildStrategy(String stockSymbol) throws SnbException, IOException, ParseException {
        ...
        if (series != null) {
            ...
            PiercingThreeWhiteIndicator candleBullishIndicator= new PiercingThreeWhiteIndicator(series);
            ...
            Rule entryRule =new BooleanIndicatorRule(candleBullishIndicator).or(new IntegerIndexIndicatorRule(new ElliotBuyIndicator(series, 2,series.getBeginIndex(), series.getEndIndex())));
